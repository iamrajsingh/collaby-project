...
class Slider3Listing extends Component {
  state = {
    sliders: [],
  ...
  handleDeleteConfirmed = async () => {
    ...
    try {
      const response = await apiService.post(
        "admin/third_slider/delete?ts_id=" + selectedListId + ""
      );
      this.setState({
        showDeleteConfirmation: false,
      });
  ...
  fetchSliderLists = async () => {
    try {
      const response = await apiService.get("admin/third_slider/");
        ...
        <div className="dashBoardSec">
          ...
          <div className="middleSec catbyMdl">
            <div className="headingD">
              <i className="fa fa-eye" aria-hidden="true"></i> Slider 3
              {/*
               */}
              <Link
                to="/admin/slider3/add"
                    ...
                    <div className="table-responsive dataTable catbyMdl">
                      ...
                      >
                        ...
                        <tbody>
                          {sliders &&
                            sliders.map((slider) => (
                              <tr className="trBack" key={slider.ts_id}>
                                <td>
                                  <button
                                    id={`DelData${slider.ts_id}`}
                                    onClick={() =>
                                      this.handleDeleteClick(slider.ts_id)
                                    }
                                  >
                                    <i
                                  ...
                                  <Link
                                    to={`/admin/slider3/edit/${slider.ts_id}`}
