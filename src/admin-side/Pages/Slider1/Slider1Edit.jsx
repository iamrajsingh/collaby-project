...
class Slider1Edit extends Component {
  state = {
    title: "",
    image: "",
    link: "",
  ...
  onUpdateTeam = async (e) => {
    ...
    try {
      ...
      formData.append("fs_id", this.state.fs_id);

      const response = await apiService.post(
        "admin/first_slider/update",
        ...
        <div className="middleSec catbyMdl">
          <form method="post" id="editfrm" onSubmit={this.onUpdateTeam}>
            <div className="headingD">
              <i className="fa fa-pencil" aria-hidden="true"></i> Edit Slider 1{" "}
              <Link
                to="/admin/slider1/listing"
...
export default withRouter(Slider1Edit);
