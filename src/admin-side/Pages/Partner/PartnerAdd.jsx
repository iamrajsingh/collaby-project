...
class PartnerAdd extends Component {
  ...
  handleSubmit = async (e) => {
    ...
    const apiEndpoint = "https://ohkolkata.com/collably/admin/partner/save";

    // Create a FormData object
    const formData = new FormData();
    formData.append("p_name", this.state.p_name);
    formData.append("p_website", this.state.p_website);
    formData.append("p_logo", this.state.p_logo);
        ...
        <div className="dashBoardSec">
          ...
          <div className="middleSec catbyMdl">
            <form method="post" id="addfrm" onSubmit={this.handleSubmit}>
              ...
              {this.state.successMessageVisible && <div
