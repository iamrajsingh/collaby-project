...
class Slider2Listing extends Component {
  state = {
    sliders: [],
  ...
  fetchSliderLists = async () => {
    try {
      const response = await apiService.get("admin/second_slider/");
  ...
  handleDeleteConfirmed = async () => {
    ...
    try {
      const response = await apiService.post(
        "admin/second_slider/delete?ss_id=" + selectedListId + ""
      );
      this.setState({
        showDeleteConfirmation: false,
      });
        ...
        <div className="dashBoardSec">
          ...
          <div className="middleSec catbyMdl">
            <div className="headingD">
              <i className="fa fa-eye" aria-hidden="true"></i> Slider 2
              {/*
               */}
              <Link
                to="/admin/slider2/add"
                    ...
                    <div className="table-responsive dataTable catbyMdl">
                      ...
                      >
                        ...
                        <tbody>
                          {sliders &&
                            sliders.map((slider) => (
                              <tr className="trBack" key={slider.ss_id}>
                                <td>
                                  <button
                                    id={`DelData${slider.ss_id}`}
                                    onClick={() =>
                                      this.handleDeleteClick(slider.ss_id)
                                    }
                                  >
                                    <i
                                  ...
                                  <Link
                                    to={`/admin/slider2/edit/${slider.ss_id}`}
