...
class Slider2Edit extends Component {
  state = {
    title: "",
    image: "",
    link: "",
  ...
  onUpdateTeam = async (e) => {
    ...
    try {
      ...
      formData.append("ss_id", this.state.ss_id);

      const response = await apiService.post(
        "admin/second_slider/update",
        ...
        <div className="middleSec catbyMdl">
          <form method="post" id="editfrm" onSubmit={this.onUpdateTeam}>
            <div className="headingD">
              <i className="fa fa-pencil" aria-hidden="true"></i> Edit Slider 2{" "}
              <Link
                href="/admin/slider2/listing"
...
export default withRouter(Slider2Edit);
