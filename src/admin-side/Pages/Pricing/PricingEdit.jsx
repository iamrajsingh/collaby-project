  ...
  componentDidMount() {
    ...
    if (teamInfo) {
      this.setState({
        ...
        priceing_type: teamInfo.priceing_type,
                ...
                <div className="row">
                  ...
                  <div className="form-group">
                      <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <select name="priceing_type" className="form-control" id="priceing_type" value={this.state.priceing_type} onChange={this.onPricingChange}>
