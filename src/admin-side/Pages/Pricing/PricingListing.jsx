...
class PricingListing extends Component {
  ...
  fetchPriceLists = async () => {
    try {
      const response = await apiService.get("admin/pricing");
  ...
  handleDeleteConfirmed = async () => {
    ...
    try {
      const response = await apiService.post("admin/pricing/delete?id=" + selectedPriceId + "");
