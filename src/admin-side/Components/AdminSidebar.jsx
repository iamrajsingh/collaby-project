        ...
        <div className="leftMenu catby">
          ...
          <div className="leftMenuSec">
            <ul>
              ...
              <li>
                <Link to="/admin/keyword/listing">
                  <i className="fa fa-users" aria-hidden="true"></i> &nbsp;
                  <span className="menuHideCl">Keyword</span>
                </Link>
              </li>
              ...
              <li>
                <Link to="/admin/slider1/listing">
                  <i className="fa fa-users" aria-hidden="true"></i> &nbsp;
                  <span className="menuHideCl">Slider1</span>
                </Link>
              </li>

              <li>
                <Link to="/admin/slider2/listing">
                  <i className="fa fa-users" aria-hidden="true"></i> &nbsp;
                  <span className="menuHideCl">Slider2</span>
                </Link>
              </li>

              <li>
                <Link to="/admin/slider3/listing">
                  <i className="fa fa-users" aria-hidden="true"></i> &nbsp;
                  <span className="menuHideCl">Slider3</span>
                </Link>
              </li>
            </ul>
          </div>
